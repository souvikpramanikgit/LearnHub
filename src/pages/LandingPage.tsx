...
import { Sun,Moon,BookOpen, Users, Award, ArrowRight, Code, Brain, Database, Link, Star, TrendingUp, BarChart3 } from 'lucide-react';
...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <nav className="bg-white/80 dark:bg-[#1a1a1a]/90 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-4 py-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button variant="ghost" onClick={handleViewCourses} className="text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:bg-green-600 dark:text-white dark:hover:bg-green-700">
              Courses
            </Button>

            <RouterLink to="/cs-fundamentals">
            <Button variant="ghost" className="text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:bg-white dark:text-green-600 dark:hover:bg-gray-100">
              CS Fundamentals
            </Button>
            </RouterLink>
            {/* DSA Sheet */}
            <button onClick={() => navigate('/dsa-sheet')} className="px-4 py-2 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-gray-900 hover:border-gray-300 font-medium transition-all duration-200 dark:bg-white dark:text-green-600 dark:border-white dark:hover:bg-gray-100">
              DSA Sheet
            </button>


            {/* Analytics */}
            <button onClick={() => navigate('/analytics')} className="flex flex-row items-center space-x-2 hover:bg-gray-100 px-4 py-2 border border-gray-200 rounded-lg text-gray-700 hover:text-gray-900 hover:border-gray-300 font-medium transition-all duration-200 dark:bg-white dark:text-green-600 dark:border-white dark:hover:bg-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:bg-[#1a1a1a] dark:bg-none py-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between px-4 gap-12">
          {/* Left: Text Content */}
          <div className="flex-1 text-center lg:text-left dark:[#1a1a1a]">
            ...
            <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 leading-tight">
              <span className="text-black dark:text-white">Master</span> <span className="text-green-700">DSA</span> <span className="text-black dark:text-white">and</span>{" "}
...
function binarySearch(arr, target) {
  return recursiveSearch(arr, 0, arr.length-1, target);
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 dark:text-green-600">
              Why Choose LearnHub?
            </h2>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="text-center">
                  <p className="text-gray-600 dark:text-blue-100">{feature.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      {/* Courses Section */}
      <section id="courses-section" className="py-20 bg-white dark:bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
              ...
              >
                ...
                <div className="transition-all">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-600 text-sm leading-relaxed dark:text-blue-100">
                      {course.description}
                    </p>
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 dark:text-green-600">CS Fundamentals</h2>
