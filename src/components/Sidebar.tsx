              ...
              <div className="p-2">
                {allCourses.map((course) => (
                  <div key={course.id} className="mb-4">
                    <button
                      className="w-full flex items-center justify-between px-3 py-2 text-sm font-semibold text-gray-800 bg-gray-200 rounded-md mb-1 focus:outline-none"
                        ...
                        {course.data.map((module: any, moduleIndex: number) => {
                          ...
                          return (
                            <div key={moduleKey} className="mb-2">
                              <button
                                className="w-full flex items-center justify-between px-3 py-2 text-sm font-semibold text-gray-900 bg-gray-100 rounded-md mb-1 focus:outline-none"
