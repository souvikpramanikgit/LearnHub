        ...
        <div className="flex items-center space-x-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" className="flex items-center space-x-2 hover:bg-green-50 dark:hover:bg-gray-800 hover:border-green-200 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">
                <span>Courses</span>
