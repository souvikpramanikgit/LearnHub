...
export const CourseContent = ({ activeSection, courseId, onSectionChange }: CourseContentProps) => {
  ...
  return (
    <div className="p-6 pt-6 max-w-4xl mx-auto bg-white text-black dark:bg-black dark:text-white">
  {/* Header */}
  <div className="mb-8">
  ...
  <div className="space-y-8">
    ...
    {content.content?.objectives && (
      <Card className="dark:bg-gray-900 dark:border-gray-800">
        <CardHeader>
          <CardTitle className="dark:text-white">Learning Objectives</CardTitle>
        </CardHeader>
        <CardContent>
    ...
    {/* Navigation */}
    <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-8 border-t border-gray-200 dark:border-gray-800 text-center">
      <Button 
        variant="outline" 
        className="flex items-center space-x-2 px-6 py-2 rounded-lg shadow-sm hover:shadow-md transition dark:text-white"
